...
public class PotionsDealerNPC implements ZoneConfigurator {
	 ...
	 private static PotionsDealerNPC instance;
	 ShopSign sign_sell;
	 ShopSign sign_buy;
	 @Override
	 ...
	 private void buildNPC(final StendhalRPZone zone) {
	  ...
	  //change here
	  sign_sell = new ShopSign("deniranpotionssell","Deniran Potions Shop", npc.getName()+" sells the following items", true);
	  sign_buy = new ShopSign("deniranpotionsbuy","Deniran Potions Shop", npc.getName()+" buy the following items", true);
	  
	  sign_sell.setEntityClass("blackboard");
	  sign_buy.setEntityClass("blackboard");
	  sign_sell.setPosition(5, 6);
	  sign_buy.setPosition(10, 6);
	 ...
	 //change
	 //private void buldShop(final StendhalRPZone zone) {
	  //sign_sell = new ShopSign("deniranpotionssell","Deniran Potions Shop", npc.getName()+" sells the following items", true);
	  //sign_buy = new ShopSign("deniranpotionsbuy","Deniran Potions Shop", npc.getName()+" buy the following items", true);
	 ...
	 //}
	 public static PotionsDealerNPC getPotionsDealerNPC() {
	  if(instance!=null) {
	   return instance;
	  }
	  else {
	   instance = new PotionsDealerNPC();
	  }
	  return instance;
	 ...
	 public ShopSign getSellShopSign() {
	  return sign_sell;
	 }
	 public ShopSign getBuyShopSign() {
	  return sign_buy;
	 }
}